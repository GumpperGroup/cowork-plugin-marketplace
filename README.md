...
2. Type `/plugin marketplace add` followed by the repository:

```
/plugin marketplace add your-github-username/biobeacon
```

1. Install the plugin:

```
/plugin install biobeacon@biobeacon
```
...
```bash
git clone https://github.com/your-github-username/biobeacon.git
```

1. In Claude Desktop / Cowork, add the local directory as a marketplace:

```
/plugin marketplace add ./path/to/biobeacon
```
